...
class SlackService:
    ...
    def __init__(self, settings: Settings):
        ...
        print(f"settings cors_origins_str here: {settings.cors_origins_str}")
    ...
    async def send_alert_notification(
        ...
        try:
            ...
            print(f"Sending slack notification for {alert_type} alert ({status})")
            print(message)
    ...
    def _format_alert_message(
        ...
        if session_id:
            text_parts.extend([
                ...
                f"*View Details:* http://localhost:5173/sessions/{session_id}"
            ])
        ...
        return {
            ...
            "icon_emoji": self.settings.slack_icon_emoji,
            "attachments": [
                {
                    "color": color,
                    "title": title,
    ...
    async def send_test_notification(self) -> bool:
        ...
        test_message = {
            ...
            "username": self.settings.slack_username,
            "icon_emoji": self.settings.slack_icon_emoji,
            "text": "🧪 *Test Notification*\n\nTarsy-Bot Slack integration is working!",
            "blocks": [
                {
                    "type": "section",
                    "text": {
