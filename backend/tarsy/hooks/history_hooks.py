...
class LLMHooks(BaseLLMHook):
    ...
    async def process_llm_interaction(self, session_id: str, interaction_data: Dict[str, Any]) -> None:
        ...
        success = self.history_service.log_llm_interaction(
            ...
            prompt_text=interaction_data["prompt_text"][:10000],  # Limit size to prevent DB issues
            response_text=interaction_data["response_text"][:10000] if interaction_data["response_text"] else "",
