...
Action Input: {"resource": "pods", "label_selector": "app=database", "namespace": "test-namespace"}""",
        ...
        with (
            ...
            #   * output: 180
            #   * total: 600
            # Executive Summary (session-level): 1 LLM call (auto-generated after completion):
            #   * input: 100 (summarizing the synthesis result)
            #   * output: 50 (generated executive summary text)
            #   * total: 150
            # Session total (Investigation + Synthesis + Executive Summary):
            #   * input: 425 + 390 + 420 + 100 = 1335
            #   * output: 150 + 145 + 180 + 50 = 525
            #   * total: 575 + 535 + 600 + 150 = 1860
            # NOTE: Executive summary is a session-level LLM interaction (no stage_execution_id)
            # generated by ExecutiveSummaryAgent.generate_executive_summary() after the final stage.
            # It's used for dashboard display and external notifications.
